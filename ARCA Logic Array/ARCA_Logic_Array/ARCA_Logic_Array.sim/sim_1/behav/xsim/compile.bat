...
REM
REM Generated by Vivado on Thu Feb 05 12:42:26 -0600 2026
...
echo "xvhdl --incr --relax -prj ARCA_Logic_Array_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj ARCA_Logic_Array_Test_Bench_vhdl.prj -log xvhdl.log
