...
REM
REM Generated by Vivado on Mon Jun 15 17:34:54 -0500 2026
...
echo "xvhdl --incr --relax -prj Processing_Element_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Processing_Element_Test_Bench_vhdl.prj -log xvhdl.log
