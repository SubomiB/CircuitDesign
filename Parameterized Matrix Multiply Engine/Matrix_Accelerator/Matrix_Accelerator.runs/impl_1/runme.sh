...
HD_PWD='C:/Users/ayode/Downloads/Parameterized Matrix Multiply Engine/Matrix_Accelerator/Matrix_Accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Matrix_Accelerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Matrix_Accelerator.tcl -notrace
