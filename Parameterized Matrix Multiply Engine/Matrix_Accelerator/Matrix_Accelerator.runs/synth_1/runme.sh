...
HD_PWD='C:/Users/ayode/Downloads/Parameterized Matrix Multiply Engine/Matrix_Accelerator/Matrix_Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Matrix_Accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Matrix_Accelerator.tcl
