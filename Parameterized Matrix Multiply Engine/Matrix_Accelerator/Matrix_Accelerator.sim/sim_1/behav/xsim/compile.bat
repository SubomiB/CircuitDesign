...
REM
REM Generated by Vivado on Wed Jul 01 21:02:44 -0500 2026
...
echo "xvhdl --incr --relax -prj Matrix_Accelerator_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Matrix_Accelerator_Test_Bench_vhdl.prj -log xvhdl.log
