...
REM
REM Generated by Vivado on Wed Jul 01 22:07:55 -0500 2026
...
echo "xvhdl --incr --relax -prj MAC_Unit_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj MAC_Unit_Test_Bench_vhdl.prj -log xvhdl.log
