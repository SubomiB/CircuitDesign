...
REM
REM Generated by Vivado on Sun Jun 21 16:45:46 -0500 2026
...
echo "xvhdl --incr --relax -prj Systolic_Array_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Systolic_Array_Test_Bench_vhdl.prj -log xvhdl.log
