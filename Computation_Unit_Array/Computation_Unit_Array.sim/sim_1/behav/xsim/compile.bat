...
REM
REM Generated by Vivado on Tue Feb 03 16:19:57 -0600 2026
...
echo "xvhdl --incr --relax -prj Computation_Array_TestBench_vhdl.prj"
call xvhdl  --incr --relax -prj Computation_Array_TestBench_vhdl.prj -log xvhdl.log
