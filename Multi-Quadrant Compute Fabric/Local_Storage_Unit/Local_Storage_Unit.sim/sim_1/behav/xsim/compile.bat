...
REM
REM Generated by Vivado on Tue Feb 24 04:38:43 -0600 2026
...
echo "xvhdl --incr --relax -prj Local_Storage_Unit_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Local_Storage_Unit_Test_Bench_vhdl.prj -log xvhdl.log
