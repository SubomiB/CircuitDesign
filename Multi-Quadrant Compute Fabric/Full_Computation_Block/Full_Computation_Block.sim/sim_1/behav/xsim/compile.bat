...
REM
REM Generated by Vivado on Tue Feb 24 04:57:57 -0600 2026
...
echo "xvhdl --incr --relax -prj Full_Block_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Full_Block_Test_Bench_vhdl.prj -log xvhdl.log
