...
REM
REM Generated by Vivado on Thu Feb 26 23:39:21 -0600 2026
...
echo "xvhdl --incr --relax -prj Full_Quadrant_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Full_Quadrant_Test_Bench_vhdl.prj -log xvhdl.log
