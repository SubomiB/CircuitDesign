...
REM
REM Generated by Vivado on Tue Feb 24 04:36:01 -0600 2026
...
echo "xvhdl --incr --relax -prj Multiplexer_2_to_1_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Multiplexer_2_to_1_Test_Bench_vhdl.prj -log xvhdl.log
