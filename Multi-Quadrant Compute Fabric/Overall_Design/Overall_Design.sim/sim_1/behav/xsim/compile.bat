...
REM
REM Generated by Vivado on Thu Feb 26 23:21:09 -0600 2026
...
echo "xvhdl --incr --relax -prj Overall_Design_Test_Bench_1_vhdl.prj"
call xvhdl  --incr --relax -prj Overall_Design_Test_Bench_1_vhdl.prj -log xvhdl.log
