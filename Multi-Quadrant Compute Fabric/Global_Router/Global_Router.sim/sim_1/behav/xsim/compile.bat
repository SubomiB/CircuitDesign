...
REM
REM Generated by Vivado on Thu Feb 26 23:44:19 -0600 2026
...
echo "xvhdl --incr --relax -prj Global_Router_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Global_Router_Test_Bench_vhdl.prj -log xvhdl.log
