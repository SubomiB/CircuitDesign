...
REM
REM Generated by Vivado on Tue Feb 24 04:42:42 -0600 2026
...
echo "xvhdl --incr --relax -prj Computation_Unit_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Computation_Unit_Test_Bench_vhdl.prj -log xvhdl.log
