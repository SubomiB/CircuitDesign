...
REM
REM Generated by Vivado on Thu Feb 26 23:41:53 -0600 2026
...
echo "xvhdl --incr --relax -prj Quadrant_Router_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Quadrant_Router_Test_Bench_vhdl.prj -log xvhdl.log
