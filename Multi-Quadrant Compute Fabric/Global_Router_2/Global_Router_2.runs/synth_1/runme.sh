...
HD_PWD='C:/Users/ojb0020/Downloads/Global_Router_2/Global_Router_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Global_Router_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Global_Router_2.tcl
