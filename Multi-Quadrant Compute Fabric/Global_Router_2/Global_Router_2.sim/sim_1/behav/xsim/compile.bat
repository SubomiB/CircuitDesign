...
REM
REM Generated by Vivado on Thu Feb 26 11:52:45 -0600 2026
...
echo "xvhdl --incr --relax -prj Global_Router_2_Test_Bench_vhdl.prj"
call xvhdl  --incr --relax -prj Global_Router_2_Test_Bench_vhdl.prj -log xvhdl.log
