...
REM
REM Generated by Vivado on Wed Feb 04 10:46:06 -0600 2026
...
echo "xvhdl --incr --relax -prj Comp_Unit_TestBench_vhdl.prj"
call xvhdl  --incr --relax -prj Comp_Unit_TestBench_vhdl.prj -log xvhdl.log
